...
int main()
{
    ...
    constexpr auto binaryFunction{ ecfcpp::function::CallCounter{ ecfcpp::function::shafferf7< BinaryChromosome > } };
    constexpr auto decimalFunction{ ecfcpp::function::CallCounter{ ecfcpp::function::shafferf7< DecimalChromosome > } };

    std::cout << "f7 binary representation,f7 decimal representation\n";
